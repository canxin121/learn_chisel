...
void VLedBlink___024root___eval_triggers__ico(VLedBlink___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VLedBlink___024root___eval_triggers__ico\n"); );
    // Body
...
void VLedBlink___024root___eval_triggers__act(VLedBlink___024root* vlSelf) {
    ...
    // Body
    vlSelf->__VactTriggered.set(0U, ((IData)(vlSelf->__Vcellinp__LedBlink__clock) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP____Vcellinp__LedBlink__clock__0))));
